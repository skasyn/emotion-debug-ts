                      ...
                      for (const [e, t] of _) {
                        ...
                        if (this.topological || this.topologicalDev) {
                          ...
                          for (const t of e.values()) {
                            ...
                            if (((a = null === e || !_.has(e.anchoredLocator.locatorHash)), !a))
                              break;
                          }
                        }
                        if (
          ...
          828: (e, t, n) => {
            ...
            (l.test = (e, t, n, { glob: o, posix: r } = {}) => {
              ...
              return (
                ...
                (!1 !== u && !0 !== a.capture) ||
                  (u =
                    !0 === a.matchBase || !0 === a.basename ? l.matchBase(e, t, n, r) : t.exec(p)),
                  ...
                  if (!0 === M || S === c) {
                    for (G++; !0 !== K() && (S = F()); )
                      if (S !== s)
                        if (S !== c) {
                          if (!0 !== M && S === l && (S = F()) === l) {
                            if (((O = j.isBrace = !0), (N = j.isGlob = !0), (U = !0), !0 === C))
                              continue;
                            break;
                          }
                          if (!0 !== M && S === i) {
                  ...
                  if (S !== p) {
                    ...
                    if (S === f)
                      for (; !0 !== K() && (e = F()); )
                        if (e !== s) {
                          if (e === R) {
                            if ((($ = j.isBracket = !0), (N = j.isGlob = !0), (U = !0), !0 === C))
                              continue;
                            break;
                          }
                        } else (P = j.backslashes = !0), F();
